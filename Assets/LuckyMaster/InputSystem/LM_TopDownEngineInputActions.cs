...
//     version 1.11.1
//     from Assets/LuckyMaster/InputSystem/LM_TopDownEngineInputActions.inputactions
//
...
{
    public partial class @LM_TopDownEngineInputActions: IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @LM_TopDownEngineInputActions()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""LM_TopDownEngineInputActions"",
    ""maps"": [
        {
            ""name"": ""PlayerControls"",
    ...
    ""controlSchemes"": [
        ...
        ~@LM_TopDownEngineInputActions()
        {
            UnityEngine.Debug.Assert(!m_PlayerControls.enabled, "This will cause a leak and performance issues, LM_TopDownEngineInputActions.PlayerControls.Disable() has not been called.");
        }
        ...
        {
            private @LM_TopDownEngineInputActions m_Wrapper;
            public PlayerControlsActions(@LM_TopDownEngineInputActions wrapper) { m_Wrapper = wrapper; }
